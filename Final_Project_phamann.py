...
def website(): #def website(): represents main function
    st.set_page_config(page_title = "CS230.5 Skyscrapers2021", page_icon = "Bentley_Logo_Shield_Only_Blue.png", layout = "wide", initial_sidebar_state = "auto", menu_items = {"About": "Name: Patrick Hamann,  Course: CS230.5,  Date: Dec 2021"}) #Source: https://docs.streamlit.io/library/api-reference/utilities/st.set_page_config
